...
The examples below use a hypothetical `database-verification` guardrail skill to illustrate the block flow (this repo ships `frontend-dev-guidelines` as its `block` guardrail):
