...
- [1. Memory Index Caps Fire Silently](#1-memory-index-caps-fire-silently)
- [2. Priority Ordering is Counterintuitive](#2-priority-ordering-is-counterintuitive)
- [3. Extraction Timing Creates Race Window](#3-extraction-timing-creates-race-window)
- [4. Derivable Content Doesn't Belong in Memory](#4-derivable-content-doesnt-belong-in-memory)
- [5. Concurrent Classification is Per-Call, Not Per-Tool](#5-concurrent-classification-is-per-call-not-per-tool)
- [6. Permission Evaluation Has Side Effects](#6-permission-evaluation-has-side-effects)
- [7. Most Async Work Skips "Pending" State](#7-most-async-work-skips-pending-state)
- [8. Fork Children Must Not Fork](#8-fork-children-must-not-fork)
- [9. Context Builders are Memoized but Manually Invalidated](#9-context-builders-are-memoized-but-manually-invalidated)
- [10. Hook Trust is All-or-Nothing](#10-hook-trust-is-all-or-nothing)
- [11. Eviction Requires Notification](#11-eviction-requires-notification)
- [12. Skill Listing Budgets Are Tight](#12-skill-listing-budgets-are-tight)
- [13. Default Tool Permission is "Allow"](#13-default-tool-permission-is-allow)
- [14. Team Memory Requires Auto-Memory Enabled](#14-team-memory-requires-auto-memory-enabled)
- [15. Orphaned Topic Files Accumulate](#15-orphaned-topic-files-accumulate)
