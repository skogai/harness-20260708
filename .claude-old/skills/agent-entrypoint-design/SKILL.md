...
The entrypoint should be navigation plus hard rules, not a long project encyclopedia. When entrypoint files are absent, use `references/build-when-missing.md`. For mirror casing and drift rules, see `references/mirror-policy.md`.
