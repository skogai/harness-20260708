...
This skill freezes new degradation first, then uses generated metrics to show current quality and convergence direction. When quality surfaces are absent, use `references/build-when-missing.md`. For generated snapshot ownership, see `references/generated-snapshot-ownership.md`.
