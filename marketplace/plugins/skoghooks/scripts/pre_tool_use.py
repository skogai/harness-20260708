...
def main():
    try:
        ...
        # .env-access and dangerous-rm blocking disabled (too many false
        # positives, e.g. `git rm -rf` tripping the rm-detection regex).
        # is_env_file_access() / is_dangerous_rm_command() kept but unused.
