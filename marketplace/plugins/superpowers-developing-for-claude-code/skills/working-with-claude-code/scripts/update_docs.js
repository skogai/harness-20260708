...
const LLMS_TXT_URL = "https://platform.claude.com/llms-full.txt";
const CLAUDE_CODE_PATTERN =
  /https:\/\/docs\.claude\.com\/en\/docs\/claude-code\/[^\s)]+\.md/g;
...
/**
 * Extract Claude Code doc URLs from llms-full.txt
 */
