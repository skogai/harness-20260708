# /sc:sc:sc:business-panel - Business Panel Analysis System

```yaml
---
command: "/sc:sc:business-panel"
...
/sc:sc:business-panel [content] --focus "competitive-analysis"
/sc:sc:business-panel [content] --synthesis-only
```
