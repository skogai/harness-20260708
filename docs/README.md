...
Consolidated documentation for the harness rebuild, gathered here during the
knowledge-extraction stage so it can be merged with the remaining modules.
...
- `.skogix/skills/` — skills are modules in their own format, not docs
- `.skogix/todo/gsd-planning/` — active planning workspace
- `CLAUDE.md`, `SKOGAI.md`, `AGENTS.md` — live agent instruction files that
  must stay at their current paths
